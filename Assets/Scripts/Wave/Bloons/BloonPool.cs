...
namespace ServiceLocator.Wave.Bloon
{
    public class BloonPool : GenericObjectPool<BloonController>
    {
        ...
        public BloonPool(PlayerService playerService, WaveService waveService, WaveScriptableObject waveScriptableObject)
        {
        ...
        protected override BloonController CreateItem() => new BloonController(playerService, bloonPrefab, bloonContainer);
    }
}
